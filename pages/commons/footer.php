...
<script src="<?php echo base_url();?>assets/table/js/dataTables.bootstrap4.min.js"></script>
...
<script src='<?php echo base_url();?>assets/calendar/js/personalizado.js'></script>
